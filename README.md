...
This demonstrates [turndown][2] – an HTML to Markdown converter in JavaScript.
...
It aims to be [CommonMark][3] compliant, and includes options to style the output. These options include:
